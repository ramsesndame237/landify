            ...
            <b-overlay>
              <b-card>
                <div class="text-center">
                  <b-card-text>
                    <b-avatar text="MU" size="7rem" rounded></b-avatar>
                  </b-card-text>
                  <b-card-text class=" h3 bold mt-1">
                   Mbouna Ulrich
                  </b-card-text>
                  <b-badge variant="success">Administrateur</b-badge>
                </div>
                ...
                <div class="">
                  ...
                  <b-list-group flush>
                    <b-list-group-item class="font-weight-bolder d-flex align-items-center font-medium-1">
                      Username:
                      <span class=" font-weight-normal ml-1">Mbouna Ulrich</span>
                    </b-list-group-item>
                    <b-list-group-item class="d-flex align-items-center font-weight-bolder font-medium-1">
                      Email :
                      <span class="font-weight-normal ml-1">tamptapion@gmail.com</span>
                    </b-list-group-item>
                    <b-list-group-item class="d-flex align-items-center font-weight-bolder font-medium-1">
                      Status:
                      <b-badge class="ml-1 font-weight-normal">Locked</b-badge>
                    </b-list-group-item>
                    <b-list-group-item class="d-flex align-items-center font-weight-bolder font-medium-1">
                      Role:
                      <span class="ml-1 font-weight-normal">Administrator</span>
                    </b-list-group-item>
                    <b-list-group-item class="d-flex align-items-center font-weight-bolder font-medium-1">
                      Mobile Phone :
                      <span class="ml-1 font-weight-normal">655 55 55 55</span>
                    </b-list-group-item>
                    <b-list-group-item class="d-flex align-items-center font-weight-bolder font-medium-1">
                      Country :
                      <span class="ml-1 font-weight-normal">Cameroun</span>
                    </b-list-group-item>
                    <b-list-group-item class="d-flex align-items-center font-weight-bolder font-medium-1">
                      Age :
                      <span class="ml-1 font-weight-normal">25</span>
                    </b-list-group-item>
                  </b-list-group>
                </div>
                <div class="d-flex justify-content-center mt-2 align-items-center">
                  <b-button variant="info" class="mx-1">Edit</b-button>
                  <b-button variant="primary" class="mx-1">Delete</b-button>
                </div>
              </b-card>
            </b-overlay>
          </div>
                  ...
                  <div class="row" >
                    <b-col class="col-12 col-sm-6">
                      <b-form-group
                        ...
                        label="Password"
                      >
                        <b-form-input size="lg" v-model="name" trim></b-form-input>
                      </b-form-group>
                    </b-col>
                    <b-col  class="col-12 col-sm-6">
                      <b-form-group
...
export default {
  name: "UserDetail",
  components: {TableGroupMatrix, CompactDataTables, TrackRecord },
  data(){
    return {
      definition: {
