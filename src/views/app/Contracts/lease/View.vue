  ...
  <div>
      ...
      >
        <div class="d-flex">
          <img
            ...
            class="mr-1"
          >
          <span>{{ $t('app.content.contract.view2') }}</span>
        </div>
    ...
    <b-card>
      <b-tabs pills>
        ...
        <b-tab :title="`${$t('app.tab.contract_tab.tab10')}`">
          <databases
            :items="users"
            :fields="rowsPayment"
          />
        </b-tab>
        <b-tab :title="`${$t('app.tab.contract_tab.tab9')}`">
          <databases
            :items="users"
            :fields="rowsInfo"
          />
...
export default {
  ...
  data() {
    return {
      ...
      rowsInfo: [
        { key: 'id', label: 'Cost type Id' },
        { key: 'name', label: 'Cost name' },
        'Action',
      ],
      rowsPayment: [
        { key: 'id', label: 'Recurring payment id' },
        { key: 'name', label: 'Recurring payment name' },
        { key: 'begin', label: 'begin date' },
        { key: 'type', label: 'Recurring payment type' },
        { key: 'maturity', label: 'maturity type' },
        { key: 'index', label: 'index clause id' },
        'Action',
      ],
      rowsCustomerGroup: [
        { key: 'id', label: 'Invoice Id' },
