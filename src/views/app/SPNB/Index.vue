      ...
      >
        ...
        >
          <b-row>
            <b-col
              cols="12"
              class="b-light d-flex justify-content-between"
            >
                ...
                >
                  ...
                  >
                    <div :class="` h-100 p-1 justify-content-center d-flex align-items-center  rounded ${(current_step == tab.step || tab.completed) ? 'step_completed' : ' text-primary bg-pink'}`">
                      <img
                        v-if="tab.completed"
                        src="@/assets/images/icons/check_rounded.png"
                        alt=""
                      >
                    </div>
                  </b-col>
        ...
        <b-card class="">
          <b-form>
            <b-row>
              ...
              >
                <b-form-group
                  :label="$t('app.form.label.ticket_id')"
                  label-for="ticket_id"
                >
                  <b-form-input
                    id="ticket_id"
              ...
              >
                <b-form-group
                  :label="$t('app.form.label.document_id')"
        ...
        >
          ...
          >
            ...
            <div class="d-flex align-items-center justify-content-between">
              <b-button
                v-if="current_step >= 1 && current_step < max_steps"
                size="md"
                class="d-flex align-items-center"
                variant="warning"
                @click="skip_step()"
