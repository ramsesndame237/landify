          ...
          <b-col v-show="activeTabItem && activeTabItem.id ==='1'" lg="12">
            <div class="d-flex justify-content-between align-items-center mb-1">
              ...
              <div class="d-flex align-items-center">
                ...
                <b-button v-b-modal.moveModal v-if="canMoveToNext() && (showButton.all || showButton.confirm)"
                          class="ml-2"
                          variant="primary">
    ...
    updateCounter(ticket_update_type, count) {
      const index = this.tabTitle.findIndex(item => {
        if (ticket_update_type === 'NEW_FILE' && item.id === '4') {
          return true;
        } else if (ticket_update_type === 'NEW_EMAIL' && item.id === '3') {
          return true;
        }
        return false;
      });
