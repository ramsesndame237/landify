<template>
  <div>
    ...
    <b-card>
      <Databases :filter="filter" link="contact-title-edit" :currentPage="currentPage" :pageOptions="pageOptions" :perPage="perPage" :items="items" :fields="fields" ref="datatable" />
    </b-card>
...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        { key: 'id', label: 'Id' },
        { key: 'group', label: "Title ID", sortable: true },
        { key: 'last_name', label: "Title", sortable: true },
        'Action',
      ],
      selected: null,
      options: [
