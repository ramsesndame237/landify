<template>
  <div>
    ...
    <b-card>
      <Databases :filter="filter" link="city-edit" :currentPage="currentPage" :pageOptions="pageOptions" :perPage="perPage" :items="items" :fields="fields" ref="datatable" />
    </b-card>
    ...
    >
      <b-form @submit.prevent>
        <b-row> 
          ...
          <b-col cols="12" md="10">
            <b-form-group
              :label="$t('app.form.label.zip_code')"
              label-for="zip_code"
              label-cols-md="3"
            >
            <b-form-input
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: 'grodup', label: "zip", sortable: true },
