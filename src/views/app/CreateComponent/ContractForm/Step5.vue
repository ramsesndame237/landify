  ...
  <b-row>
    ...
    <b-col cols="12" md="6">
      <data-tables
        ...
        :items="costTypes" :can-make-delete-call="false"
...
export default {
  ...
  data() {
    const relation = { ...Table.contract }.relations.find(rel => rel.entity === 'frontend_3_4_3_5')
    ...
    return {
      ...
      entity: {},
      fields,
      costTypes: this.context.costTypes || [],
      loading: false,
  ...
  methods: {
    async submit() {
      ...
      await this.$http.post('/contracts/step/4', data)
    },
  },
}
</script>
