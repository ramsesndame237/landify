  ...
  <b-row>
    ...
    <b-col cols="12" md="6" class="p-0">
      <entity-form
        ...
        table-definition-key="contract_criteria_rel"
        is-relation
        :disabled="disabled"
        create
        cols="12"
...
export default {
  ...
  data() {
    const definition = {...Table.contract}.relations.find(rel => rel.entity === 'frontend_3_4_3_4')
    definition.submit = (vm) => {
      ...
      return vm.$http.post('/contracts/step/6', data)
    }
    const fields = []
    ...
    return {
      definition,
      fields,
      criteriaIds: this.context.criteriaIds || [],
      loading: false,
      idsName: 'criteriaIds'
    }
  },
