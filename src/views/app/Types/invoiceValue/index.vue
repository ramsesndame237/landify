<template>
  <div>
    ...
    <b-modal
        ...
        centered
        :title="$t('app.content.create_new_invoice_value_type')"
        size="lg"
    >
      <b-form @submit.prevent>
        <b-row>
          ...
          <b-col cols="12">
            <b-form-group
                :label=" $t('app.form.label.unit_id') "
                label-for="description"
                label-cols-md="4"
            >
              <b-form-select
          ...
          <b-col cols="12">
            <b-form-group
                :label=" $t('app.form.label.invoicevaluetype_unit_preferred_unit') "
                label-for="description"
                label-cols-md="4"
            >
              <b-form-radio-group
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: 'invoicevaluetype_description', label: 'invoicevaluetype_description', sortable: true },
        { key: 'invoicevaluetype_unit_rel.unit_id', label: 'invoicevaluetype_unit_rel.unit_id', sortable: true },
        { key: 'invoicevaluetype_unit_rel.	invoicevaluetype_unit_preferred_unit', label: 'invoicevaluetype_unit_rel.	invoicevaluetype_unit_preferred_unit', sortable: true },
        { key: '# of invoice_id **', label: '# of invoice_id **', sortable: true },
        'Action',
      ],
      selected: null,
      filter: null,
