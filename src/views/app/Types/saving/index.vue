<template>
  <div>
    ...
    <b-modal
        ...
        centered
        :title="$t('app.content.create_new_saving_type')"
        size="lg"
    >
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: 'inspecttion', label: '# of inspectionresult_id **', sortable: true },
        { key: 'group_name', label: 'sum of inspectionresult_value **', sortable: true },
        'Action',
      ],
      selected: null,
      filter: null,
