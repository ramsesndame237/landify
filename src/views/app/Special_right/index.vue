  ...
  <div>
    ...
    <b-card>
      <Databases
        ref="datatable"
        :filter="filter"
        link="special-right-view"
        link_view="special-right-view"
...
export default {
  ...
  data() {
    return {
      ...
      items: ['', '', ''],
      fields: [
        { key: 'id', label: 'special right ID ' },
        { key: 'group_id', label: 'Special right name', sortable: false },
        { key: 'group_name', label: 'Special right description ', sortable: true },
        { key: 'group_fname', label: '# of contracts', sortable: true },
        'Action',
      ],
      selected: null,
      filter: null,
