  ...
  invoice: {
    ...
    relations: [
        ...
        fields: [
          {
            key: 'invoice_id',
            type: 'list',
            relationEntity: 'invoice_invoicevaluetype_rel',
            hideOnForm: true,
            hideOnIndex: true,
            with: ['invoice_invoicevaluetype_value'],
          },
          { key: 'invoice_name' },
          ...
          { key: 'unit_name', hideOnForm: true },
          {
            key: 'unit_id',
            type: 'list',
            relationEntity: 'invoicevaluetype_unit_rel',
            hideOnForm: true,
            hideOnIndex: true,
          },
        ],
      },
      {
        ...
        entityForm: 'invoicecriteria',
        primaryKey: 'invoicecriteria_id',
        fields: [
          {
            key: 'invoice_id',
            type: 'list',
            relationEntity: 'invoice_invoicecriteria_rel',
            hideOnForm: true,
            hideOnIndex: true,
            with: ['invoice_invoicecriteria_is_set'],
          },
          { key: 'invoicecriteria_name' },
          { key: 'invoicecriteria_description' },
      ...
      },
      {
        ...
        entityForm: 'invoicedeadline',
        primaryKey: 'invoicedeadline_id',
        fields: [
          {
            key: 'invoice_id',
            type: 'list',
            relationEntity: 'invoice_invoicedeadline_rel',
            hideOnForm: true,
            hideOnIndex: true,
            with: ['invoice_invoicedeadline_date'],
          },
          { key: 'invoicedeadline_name' },
          { key: 'invoicedeadline_description', type: 'textarea' },
